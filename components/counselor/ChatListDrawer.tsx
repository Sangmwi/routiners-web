...
import type { CounselorConversationListItem, ActivePurposeType } from '@/lib/types/counselor';
...
interface ConversationItemProps {
  item: CounselorConversationListItem;
  isCurrent: boolean;
  onSelect: () => void;
  onDelete: () => void;
}
...
function groupByDate(
  conversations: CounselorConversationListItem[]
): Record<string, CounselorConversationListItem[]> {
  const groups: Record<string, CounselorConversationListItem[]> = {};
  const now = new Date();
