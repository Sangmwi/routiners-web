...
export function transformExtractedToCreateData(
  ...
  return {
    ...
    bmi: extracted.bmi,
    inbodyScore: extracted.inbody_score,
    totalBodyWater: extracted.total_body_water,
    protein: extracted.protein,
    minerals: extracted.minerals,
    bodyFatMass: extracted.body_fat_mass,
    rightArmMuscle: extracted.right_arm_muscle,
    leftArmMuscle: extracted.left_arm_muscle,
    trunkMuscle: extracted.trunk_muscle,
    rightLegMuscle: extracted.right_leg_muscle,
    leftLegMuscle: extracted.left_leg_muscle,
    rightArmFat: extracted.right_arm_fat,
    leftArmFat: extracted.left_arm_fat,
    trunkFat: extracted.trunk_fat,
    rightLegFat: extracted.right_leg_fat,
    leftLegFat: extracted.left_leg_fat,
  };
}
