import { HouseIcon, CalendarIcon, ChartBarIcon, UsersThreeIcon, UserCircleIcon, CaretLeftIcon, CaretRightIcon } from '@phosphor-icons/react';
...
export const BOTTOM_NAV = {
  items: [
    ...
    { key: 'stats', label: '통계', href: '/stats', icon: ChartBarIcon },
